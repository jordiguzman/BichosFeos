package appkite.jordiguzman.com.bichosfeos.touchImageView.ui.tabanos;
...
import appkite.jordiguzman.com.bichosfeos.touchImageView.provider.Tabanos_url;
...
public class TabanosPager extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setAdapter(new TabanosPager.TouchImageAdapter());


        TabanosPager.context = getApplicationContext();
    ...
    public void bajar()  {
        ...
        try {
            myWebLink.setData(Uri.parse("http://jordiguzman.com/bf/Tabanos.zip"));
        }catch (Exception e){
    ...
    public void irWiki() {
        Intent in = new Intent(TabanosPager.this, VisorWeb.class);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Objects.equals(idioma, "en") || Objects.equals(idioma, "en_GB") || Objects.equals(idioma, "en_US")||
                ...
                in.putExtra("urlWiki", Tabanos_url.tabanosUrlWikiEn[posImagen]);
            }if (Objects.equals(idioma, "es")|| Objects.equals(idioma, "es_ES")) {
                in.putExtra("urlWiki", Tabanos_url.tabanosUrlWiki[posImagen]);
            }
        }
    ...
    class TouchImageAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            return Tabanos_url.tabanosUrl.length;
        }
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            Glide.with(getAppContext())
                    .load(Tabanos_url.tabanosUrl[position])
                    .asBitmap()
                ...
                public void onClick(View v) {
                    ...
                    try {
                        switch (position){
                            ...
                            case 0:
                                tv_modelo.setText(R.string.tabano);
                                posImagen=0;

                                break;
                            case 1:
                                tv_modelo.setText(R.string.tabano2);
                                posImagen=1;
                                break;
                            case 2:
                                tv_modelo.setText(R.string.tabano3);
                                posImagen=2;
                                break;
                            case 3:
                                tv_modelo.setText(R.string.tabano4);
                                posImagen=3;
                                break;
                            case 4:
                                tv_modelo.setText(R.string.tabano5);
                                posImagen=4;
                                break;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        posImagen=-1;
        Intent in = new Intent(TabanosPager.this, MenuImagenes.class);
        startActivity(in);
    }
