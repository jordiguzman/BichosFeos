package appkite.jordiguzman.com.bichosfeos.touchImageView.ui.coloreadas;
...
import appkite.jordiguzman.com.bichosfeos.touchImageView.provider.Coloreadas_url;
...
import appkite.jordiguzman.com.bichosfeos.touchImageView.ui.escarabajos.EditarImagenEscarabajos;
import appkite.jordiguzman.com.bichosfeos.touchImageView.ui.mantis.MantisPager;


@SuppressWarnings("ALL")
public class ColoreadasPager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ColoreadasPager.context = getApplicationContext();
    ...
    public void bajar()  {
        ...
        try {
            myWebLink.setData(Uri.parse("http://jordiguzman.com/bf/Color.zip"));
        }catch (Exception e){
    ...
    public void irWiki() {
        Intent in = new Intent(ColoreadasPager.this, VisorWeb.class);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Objects.equals(idioma, "en") || Objects.equals(idioma, "en_GB") || Objects.equals(idioma, "en_US") ||
                ...
                in.putExtra("urlWiki", Coloreadas_url.coloreadasUrlWikiEn[posImagen]);
            }if (Objects.equals(idioma, "es") || Objects.equals(idioma, "es_ES")) {
                in.putExtra("urlWiki", Coloreadas_url.coloreadasUrlWiki[posImagen]);
            }
        }
    ...
    public static Context getAppContext() {
        return ColoreadasPager.context;
    }
    ...
    class TouchImageAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            return Coloreadas_url.coloreadasUrl.length;
        }
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            Glide.with(getAppContext())
                    .load(Coloreadas_url.coloreadasUrl[position])
                    .asBitmap()
                ...
                public void onClick(View v) {
                    ...
                    try {
                        switch (position){
                            ...
                            case 0:
                                tv_modelo.setText(R.string.coloreadas);
                                posImagen=0;

                                break;
                            case 1:
                                tv_modelo.setText(R.string.coloreadas2);
                                posImagen=1;
                                break;
                            case 2:
                                tv_modelo.setText(R.string.coloreadas3);
                                posImagen=2;
                                break;
                            case 3:
                                tv_modelo.setText(R.string.coloreadas4);
                                posImagen=3;
                                break;
                            case 4:
                                tv_modelo.setText(R.string.coloreadas5);
                                posImagen=4;
                                break;
                            case 5:
                                tv_modelo.setText(R.string.coloreadas6);
                                posImagen=5;
                                break;
                            case 6:
                                tv_modelo.setText(R.string.coloreadas7);
                                posImagen=6;
                                break;
                            case 7:
                                tv_modelo.setText(R.string.coloreadas8);
                                posImagen=7;
                                break;
                            case 8:
                                tv_modelo.setText(R.string.coloreadas9);
                                posImagen=8;
                                break;
                            case 9:
                                tv_modelo.setText(R.string.coloreadas10);
                                posImagen=9;
                                break;
                            case 10:
                                tv_modelo.setText(R.string.coloreadas11);
                                posImagen=10;
                                break;
                            case 11:
                                tv_modelo.setText(R.string.coloreadas12);
                                posImagen=11;
                                break;
                            case 12:
                                tv_modelo.setText(R.string.coloreadas13);
                                posImagen=12;
                                break;
                            case 13:
                                tv_modelo.setText(R.string.coloreadas14);
                                posImagen=13;
                                break;
                            case 14:
                                tv_modelo.setText(R.string.coloreadas15);
                                posImagen=14;
                                break;
                            case 15:
                                tv_modelo.setText(R.string.coloreadas16);
                                posImagen=15;
                                break;
                            case 16:
                                tv_modelo.setText(R.string.coloreadas17);
                                posImagen=16;
                                break;
                            case 17:
                                tv_modelo.setText(R.string.coloreadas18);
                                posImagen=17;
                                break;
                            case 18:
                                tv_modelo.setText(R.string.coloreadas19);
                                posImagen=18;
                                break;
                            case 19:
                                tv_modelo.setText(R.string.coloreadas20);
                                posImagen=19;
                                break;
                            case 20:
                                tv_modelo.setText(R.string.coloreadas21);
                                posImagen=20;
                                break;
                            case 21:
                                tv_modelo.setText(R.string.coloreadas22);
                                posImagen=21;
                                break;
                            case 22:
                                tv_modelo.setText(R.string.coloreadas23);
                                posImagen=22;
                                break;
                        }
                    }catch (Exception e){
    ...
    public void onBackPressed() {
        super.onBackPressed();
        posImagen=-1;
        Intent in = new Intent(ColoreadasPager.this, MenuImagenes.class);
        startActivity(in);
    }
