package appkite.jordiguzman.com.bichosfeos.touchImageView.ui.gorgojos;
...
public class GorgojosPager extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setAdapter(new GorgojosPager.TouchImageAdapter());


        GorgojosPager.context = getApplicationContext();
    ...
    public void bajar()  {
        ...
        try {
            myWebLink.setData(Uri.parse("http://jordiguzman.com/bf/Gorgojo.zip"));
        }catch (Exception e){
    ...
    public void irWiki() {
        Intent in = new Intent(GorgojosPager.this, VisorWeb.class);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Objects.equals(idioma, "en") || Objects.equals(idioma, "en_GB") || Objects.equals(idioma, "en_US")||
                ...
                in.putExtra("urlWiki", Gorgojos_url.gorgojosUrlWikiEn[posImagen]);
            }if (Objects.equals(idioma, "es")|| Objects.equals(idioma, "es_ES")){
                in.putExtra("urlWiki", Gorgojos_url.gorgojosUrlWiki[posImagen]);
            }
        }
    ...
    class TouchImageAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            return Gorgojos_url.gorgojosUrl.length;
        }
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            Glide.with(getAppContext())
                    .load(Gorgojos_url.gorgojosUrl[position])
                    .asBitmap()
                ...
                public void onClick(View v) {
                    ...
                    try {
                        switch (position){
                            ...
                            case 0:
                                tv_modelo.setText(R.string.gorgojo);
                                posImagen=0;

                                break;
                            case 1:
                                tv_modelo.setText(R.string.gorgojo2);
                                posImagen=1;
                                break;
                            case 2:
                                tv_modelo.setText(R.string.gorgojo3);
                                posImagen=2;
                                break;
                            case 3:
                                tv_modelo.setText(R.string.gorgojo4);
                                posImagen=3;
                                break;
                            case 4:
                                tv_modelo.setText(R.string.gorgojo5);
                                posImagen=4;
                                break;
                            case 5:
                                tv_modelo.setText(R.string.gorgojo6);
                                posImagen=5;
                                break;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        posImagen=-1;
        Intent in = new Intent(GorgojosPager.this, MenuImagenes.class);
        startActivity(in);
    }
