package appkite.jordiguzman.com.bichosfeos.touchImageView.ui.saltamontes;
...
import appkite.jordiguzman.com.bichosfeos.touchImageView.provider.Saltamontes_url;
...
public class SaltamontesPager extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setAdapter(new SaltamontesPager.TouchImageAdapter());


        SaltamontesPager.context = getApplicationContext();
    ...
    public void bajar()  {
        ...
        try {
            myWebLink.setData(Uri.parse("http://jordiguzman.com/bf/Saltamontes.zip"));
        }catch (Exception e){
    ...
    public void irWiki() {
        Intent in = new Intent(SaltamontesPager.this, VisorWeb.class);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Objects.equals(idioma, "en") || Objects.equals(idioma, "en_GB") || Objects.equals(idioma, "en_US")||
                ...
                in.putExtra("urlWiki", Saltamontes_url.saltamontesUrlWikiEn[posImagen]);
            }if (Objects.equals(idioma, "es")|| Objects.equals(idioma, "es_ES")){
                in.putExtra("urlWiki", Saltamontes_url.saltamontesUrlWiki[posImagen]);
            }
        }
    ...
    public static Context getAppContext() {
        return SaltamontesPager.context;
    }
    ...
    class TouchImageAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            return Saltamontes_url.saltamontesUrl.length;
        }
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            Glide.with(getAppContext())
                    .load(Saltamontes_url.saltamontesUrl[position])
                    .asBitmap()
                ...
                public void onClick(View v) {
                    ...
                    try {
                        switch (position){
                            ...
                            case 0:
                                tv_modelo.setText(R.string.saltamontes);
                                posImagen=0;

                                break;
                            case 1:
                                tv_modelo.setText(R.string.saltamontes2);
                                posImagen=1;
                                break;
                            case 2:
                                tv_modelo.setText(R.string.saltamontes3);
                                posImagen=2;
                                break;
                            case 3:
                                tv_modelo.setText(R.string.saltamontes4);
                                posImagen=3;
                                break;
                            case 4:
                                tv_modelo.setText(R.string.saltamontes5);
                                posImagen=4;
                                break;
                            case 5:
                                tv_modelo.setText(R.string.saltamontes6);
                                posImagen=5;
                                break;
                            case 6:
                                tv_modelo.setText(R.string.saltamontes7);
                                posImagen=6;
                                break;
                        ...
                        e.printStackTrace();
                        Toast.makeText(getAppContext(), "Error al cargar la imagen", Toast.LENGTH_LONG).show();
                    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        posImagen=-1;
        Intent in= new Intent(SaltamontesPager.this, MenuImagenes.class);
        startActivity(in);
    }
