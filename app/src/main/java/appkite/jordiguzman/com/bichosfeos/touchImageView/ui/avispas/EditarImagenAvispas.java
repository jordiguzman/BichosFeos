...
public class EditarImagenAvispas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (numero) {
            case 0:
                tv_editar.setText(R.string.avispa);
                break;
            case 1:
                tv_editar.setText(R.string.avispa2);
                break;
            case 2:
                tv_editar.setText(R.string.avispa3);
                break;
            case 3:
                tv_editar.setText(R.string.avispa4);
                break;
            case 4:
                tv_editar.setText(R.string.avispa5);
                break;
            case 5:
                tv_editar.setText(R.string.avispa6);
                break;
            case 6:
                tv_editar.setText(R.string.avispa7);
                break;
            case 7:
                tv_editar.setText(R.string.avispa8);
                break;
        }
    ...
    public void irWiki(String string) {
        Intent in = new Intent(EditarImagenAvispas.this, VisorWeb.class);
