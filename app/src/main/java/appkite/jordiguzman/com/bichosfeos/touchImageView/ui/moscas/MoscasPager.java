package appkite.jordiguzman.com.bichosfeos.touchImageView.ui.moscas;
...
public class MoscasPager extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setAdapter(new MoscasPager.TouchImageAdapter());


        MoscasPager.context = getApplicationContext();
    ...
    public void bajar()  {
        ...
        try {
            myWebLink.setData(Uri.parse("http://jordiguzman.com/bf/Mosca.zip"));
        }catch (Exception e){
    ...
    public void irWiki() {
        Intent in = new Intent(MoscasPager.this, VisorWeb.class);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (Objects.equals(idioma, "en") || Objects.equals(idioma, "en_GB") || Objects.equals(idioma, "en_US")||
                ...
                in.putExtra("urlWiki", Moscas_url.moscasUrlWikiEn[posImagen]);
            }if (Objects.equals(idioma, "es")) {
                in.putExtra("urlWiki", Moscas_url.moscasUrlWiki[posImagen]);
            }
        }
    ...
    class TouchImageAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            return Moscas_url.moscasUrl.length;
        }
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            Glide.with(getAppContext())
                    .load(Moscas_url.moscasUrl[position])
                    .asBitmap()
                ...
                public void onClick(View v) {
                    ...
                    try {
                        switch (position){
                            ...
                            case 0:
                                tv_modelo.setText(R.string.mosca);
                                posImagen=0;

                                break;
                            case 1:
                                tv_modelo.setText(R.string.mosca2);
                                posImagen=1;
                                break;
                            case 2:
                                tv_modelo.setText(R.string.mosca3);
                                posImagen=2;
                                break;
                            case 3:
                                tv_modelo.setText(R.string.mosca4);
                                posImagen=3;
                                break;
                            case 4:
                                tv_modelo.setText(R.string.mosca5);
                                posImagen=4;
                                break;
                            case 5:
                                tv_modelo.setText(R.string.mosca6);
                                posImagen=5;
                                break;
                            case 6:
                                tv_modelo.setText(R.string.mosca7);
                                posImagen=6;
                                break;
                            case 7:
                                tv_modelo.setText(R.string.mosca8);
                                posImagen=7;
                                break;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        posImagen=-1;
        Intent in= new Intent(MoscasPager.this, MenuImagenes.class);
        startActivity(in);
    }
