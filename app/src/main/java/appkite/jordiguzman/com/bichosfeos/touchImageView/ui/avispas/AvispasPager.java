package appkite.jordiguzman.com.bichosfeos.touchImageView.ui.avispas;
...
public class AvispasPager extends AppCompatActivity {
    ...
    public final static int NUM_IMAGEN=-1;
    public static int numImagen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AvispasPager.context = getApplicationContext();
    ...
    public void bajar()  {
        ...
        try {
            myWebLink.setData(Uri.parse("http://jordiguzman.com/bf/Avispas.zip"));
        }catch (Exception e){
    ...
    public void irWiki() {
        ...
        Intent in = new Intent(AvispasPager.this, VisorWeb.class);

         idioma= String.valueOf(Locale.getDefault());
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                if (Objects.equals(idioma, "en") || Objects.equals(idioma, "en_GB") || Objects.equals(idioma, "en_US")||
                    ...
                    in.putExtra("urlWiki", Avispas_url.avispasUrlWikiEn[posImagen]);
                }
                if (Objects.equals(idioma, "es") || Objects.equals(idioma, "es_ES")){
                    in.putExtra("urlWiki", Avispas_url.avispasUrlWiki[posImagen]);
                }
                startActivity(in);
            }
    ...
    class TouchImageAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            return Avispas_url.avispasUrl.length;
        }
        ...
        public View instantiateItem(ViewGroup container, final int position) {
            ...
            Glide.with(getAppContext())
                    .load(Avispas_url.avispasUrl[position])
                    .asBitmap()
                ...
                public void onClick(View v) {
                    ...
                    try {
                        switch (position){
                            ...
                            case 0:
                                tv_modelo.setText(R.string.avispa);
                                posImagen=0;
                                break;
                            case 1:
                                tv_modelo.setText(R.string.avispa2);
                                posImagen=1;
                                break;
                            case 2:
                                tv_modelo.setText(R.string.avispa3);
                                posImagen=2;
                                break;
                            case 3:
                                tv_modelo.setText(R.string.avispa4);
                                posImagen=3;
                                break;
                            case 4:
                                tv_modelo.setText(R.string.avispa5);
                                posImagen=4;
                                break;
                            case 5:
                                tv_modelo.setText(R.string.avispa6);
                                posImagen=5;
                                break;
                            case 6:
                                tv_modelo.setText(R.string.avispa7);
                                posImagen=6;
                                break;
                            case 7:
                                tv_modelo.setText(R.string.avispa8);
                                posImagen=7;
                                break;
                        }
                    }catch (Exception e){
    ...
    public void onBackPressed() {
        super.onBackPressed();
        posImagen=-1;
        Intent in = new Intent(AvispasPager.this, MenuImagenes.class);
        startActivity(in);
    }
